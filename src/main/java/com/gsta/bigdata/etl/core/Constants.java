...
public class Constants {
	...
	public final static String CF_NAME_KAFKA_STREAM_PROCESS = "kafkaStreamProcess";
	...
	public final static String ATTR_COOKIE = "cookie";
