...
public final class URLocation {
	...
	public  static void main(String [] args){
		String str = "java:///etl.xml";
		str = "http://www.163.com/abc";
		str = "www.163.com/abc";
		str = "https://www.163.com";
		URLocation parser = new URLocation(str);
		System.out.println(parser.getScheme());
		System.out.println("host=" + parser.getServer());
		System.out.println(parser.getPort());
		System.out.println(parser.getPath());

		StringMatcher matcher = new StringMatcher("/*");
		System.out.println(matcher.match(parser.getPath()));		
	}
}
